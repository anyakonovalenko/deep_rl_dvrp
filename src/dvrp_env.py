...
import os
import numpy as np
from src.utils.utils import fill_cell_im, draw_image, vrp_action_go_from_a_to_b
import copy
from src.utils.const import *
from src.utils.draw import *
from src.utils.sim_annel import *
from src.utils.cheapest_insertion import *
    ...
    def __orig_step(self, action):
        ...
        if self.clock >= self.episode_length:
            ...
            if (self.experiment_index == 1000):
                ...
                df_2.to_csv("data/evaluation/combine_all_rs_3.csv", index=False)
    ...
    def reset(self):
        ...
        if self.evaluation:
            try:
                ...
                self.test_dataframe = pd.read_csv(f'data/instances/test/{self.experiment_index}.csv')
            except:
